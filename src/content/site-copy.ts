...
export const siteCopy = {
  metadata: {
    ...
    ogTitle: "Quỹ Nuôi Em",
    description:
      "Nuôi cơm trưa cho trẻ vùng cao: mỗi mã NE tương ứng 1 học sinh - 1 người nuôi, không trùng lặp. 150.000–170.000đ/tháng, minh bạch thu chi, tra cứu hồ sơ và đi thăm bé trên quynuoiem.com.",
    keywords:
  ...
  nav: {
    ...
    contact: "Liên hệ",
    donate: "Đóng góp",
    receiveCode: "Nhận mã NE",
    receiveCodeShort: "Nhận mã NE",
    openMenu: "Mở menu",
    closeMenu: "Đóng menu",
  },
  buildNotice: {
  ...
  footer: {
    ...
    tagline: "Dự án nuôi cơm trưa cho trẻ vùng cao",
  ...
  home: {
    ...
    title: "Quỹ Nuôi Em",
    description:
      'Trên những mái nhà tranh vùng cao, chỉ từ 150.000đ – 170.000đ mỗi tháng, anh chị đã mang đến những bữa cơm trưa no bụng, giữ bước chân các em nhỏ đi học đều đặn. Với mô hình "Mỗi mã NE tương ứng 1 học sinh - 1 người nuôi", anh chị sẽ biết rõ thông tin và có thể đến thăm em nuôi của mình.',
  ...
  homePopup: {
    ...
    closeLabel: "Đóng",
    imageAlt: "Các em nhỏ tham gia dự án Nuôi Em tại điểm trường vùng cao",
  },
} as const;
