...
const pillActive = "rounded-full bg-brand-blue px-4 py-2 text-sm font-semibold text-white shadow-sm";
const pillInactive =
  "rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-700 transition-colors hover:border-brand-blue/30 hover:text-brand-blue";
